...
# Kalau file belum ada, buat kosong biar sed nggak error
[ ! -f /etc/nginx/conf.d/xray.conf ] && touch /etc/nginx/conf.d/xray.conf

# --- Base config nginx untuk Xray ---
...
server {
    ...
    ssl_ciphers ECDHE+CHACHA20:ECDHE+AES128:ECDHE+AES256:!MD5;
