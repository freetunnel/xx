...
echo -e "                  ${WH}  XRAY : ${status_xray} ${WH} NGINX : ${status_nginx}"
echo -e "    $COLOR1╰═══════════════════════════════════════════════════╯${NC}"
...
cd
rm -rf *
wget https://raw.githubusercontent.com/Freetunnel/xx/main/update.sh
clear
chmod +x update.sh && ./update.sh
}
echo -e "$COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│$NC ${WH} ❈ Versi   ${NC}: ${WH}$X-RAY Version${NC}"
